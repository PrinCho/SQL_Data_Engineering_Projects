...
![Project 1 Overview]([../Images\1_1_Project1_EDA.png](https://github.com/PrinCho/SQL_Data_Engineering_Projects/blob/main/Images/1_1_Project1_EDA.png?raw=true))
...
If have a minute, review these:

1. [Top Demanded Skills Query](01_top_demanded_skills.sql)  - demand analysis with multi-table-join
2. [Top Paying Skills Query](02_top_paying_skill.sql)  - salay analysis with aggregations
3. [Most Optimal Skills Query](03_most_optimal_skill.sql)  - combined salary/demand optimization query
